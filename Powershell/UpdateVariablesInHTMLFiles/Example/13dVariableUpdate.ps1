$name = "4Fre5h"
$count = 466
$spath = "G:\My Drive\HP Laptop\Projects\CNFTs\InProgress\JS\4fre5h\workint\Test\test\template2d.html"
$opath = "G:\My Drive\HP Laptop\Projects\CNFTs\InProgress\JS\4fre5h\workint\Test\test\2d\"
$text = "additionalText"

For ($i=1; $i -le $count; $i++) {
$d1 = Get-Random -Minimum 300.000 -Maximum 500.009
$d2 = Get-Random -Minimum 300.000 -Maximum 500.009
$dIndex = "getRandomInt(0, 1);"
